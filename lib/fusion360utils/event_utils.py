...
from ...lib.common.nnws_constants import CALLBACK_NAME
...
def _create_handler(handler_type, callback: Callable, event: adsk.core.Event, name: str = None, local_handlers: list = None):
...
def _define_handler(handler_type, callback, name: str = None):
    ...
    class Handler(handler_type):
        ...
        def notify(self, args):
            try:
                if CALLBACK_NAME == callback.__name__ and isinstance(args, adsk.core.CommandEventArgs):
